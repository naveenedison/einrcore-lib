...
Transaction.MAX_MONEY = 84000000 * 1e8; // einrcoin has 84M coins
...
Transaction.FEE_PER_KB = 100000; // einrcoin default fees is 0.001 EINR
...
Transaction.prototype.checkedSerialize = function(opts) {
  ...
  if (serializationError) {
    serializationError.message += ' - For more information please see: ' +
      'http://einrcore.io/guide/transaction.html#serialization-checks';
 ...
 * and a slightly fancier format recognized by einrcore:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a einrcore Address object. The
 * same is true for `script`, which can be a string or a einrcore Script.
 *
